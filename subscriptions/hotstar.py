...
Builder.load_file('kv/hotstar.kv')

class HotstarScreen(Screen):
    ...
    def save_subscription(self, plan, popup):
        try:
            ...
            if user_data:
                ...
                cursor.execute('''INSERT INTO hotstar_subscriptions (id, first_name, last_name, email, mobile, plan, applied_date)
                                  VALUES (?, ?, ?, ?, ?, ?, ?)''',
    ...
    def show_success_message(self, plan, first_name, mobile):
        ...
        success_message = (
            ...
            f"Thank you, {first_name}, for subscribing to Hotstar on our website.\n\n"
