...
Builder.load_file('kv/amazon.kv')
...
class AmazonScreen(Screen):
    ...
    def save_subscription(self, plan, popup):
        try:
            ...
            if user_data:
                ...
                cursor.execute('''INSERT INTO amazon_subscriptions (id, first_name, last_name, email, mobile, plan, applied_date)
                                  VALUES (?, ?, ?, ?, ?, ?, ?)''',
    ...
    def show_success_message(self, plan, first_name, mobile):
        ...
        success_message = (
            ...
            f"Thank you, {first_name}, for subscribing to Amazon on our website.\n\n"
